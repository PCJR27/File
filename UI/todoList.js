...
// const todoManagement =require('../lib/todoManagement.js')
 function todoUserInterface() {
  ...
  function removeTodoItem(removeId) {
    // const  callList=document.getElementById('listTodo')
    // const deleteNode=callList.children[removeId]
    // callList.removeChild(deleteNode)
    const call=document.getElementById(removeId)
